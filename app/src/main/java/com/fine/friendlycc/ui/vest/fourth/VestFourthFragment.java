package com.fine.friendlycc.ui.vest.fourth;
 ...
 * @author wulei
 */
public class VestFourthFragment extends BaseRefreshFragment<FragmentMineBinding, VestFourthViewModel> {
    ...
    @Override
    public VestFourthViewModel initViewModel() {
        AppViewModelFactory factory = AppViewModelFactory.getInstance(mActivity.getApplication());
        return ViewModelProviders.of(this, factory).get(VestFourthViewModel.class);
    }
        ...
        binding.appbarLayout.addOnOffsetChangedListener(new AppBarStateChangeListener() {
            ...
            public void onStateChanged(AppBarLayout appBarLayout, State state) {
                if (state == State.EXPANDED) {
                    ...
                    ImmersionBarUtils.setupStatusBar(VestFourthFragment.this, false, true);
                } else if (state == State.COLLAPSED) {
                    //折叠状态
                    binding.layoutTitle.setVisibility(View.VISIBLE);
                    ImmersionBarUtils.setupStatusBar(VestFourthFragment.this, true, true);
                } else {
                    //中间状态
        ...
        binding.audioStop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(userInfoEntity!=null && !StringUtils.isEmpty(userInfoEntity.getSound()) ){
                    ...
                    if (AudioPlayer.getInstance().isPlaying()) {
                        AudioPlayer.getInstance().stopPlay();
                        Glide.with(VestFourthFragment.this.getContext()).asGif().load(R.drawable.audio_waves_stop)
                                .error(R.drawable.audio_waves_stop)
                                .placeholder(R.drawable.audio_waves_stop)
                                .into(binding.audioWaves);
                        return;
                    }
                    Glide.with(VestFourthFragment.this.getContext()).asGif().load(R.drawable.audio_waves)
                            .error(R.drawable.audio_waves_stop)
                            .placeholder(R.drawable.audio_waves_stop)
                            .into(binding.audioWaves);
                    ...
                    .setOnItemSelectedListener((bottomSheet, position) -> {
                        ...
                        if (position == 0) {
                            ...
                            if (viewModel.userInfoEntity.get().getSex() == 0 && viewModel.userInfoEntity.get().getIsVip() != 1) {
                                MVDialog.getInstance(VestFourthFragment.this.getContext())
