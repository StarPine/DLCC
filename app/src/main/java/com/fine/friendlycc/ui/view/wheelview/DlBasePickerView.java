...
public class DlBasePickerView {
    ...
    protected DlPickerOptions mPickerOptions;
    ...
    public DlBasePickerView(Context context) {
        ...
        mPickerOptions.decorView.post(new Runnable() {
            ...
            public void run() {
                ...
                if (onDismissListener != null) {
                    onDismissListener.onDismiss(DlBasePickerView.this);
                }
            }
        });
    ...
    public DlBasePickerView setOnDismissListener(OnDismissListener onDismissListener) {
    ...
    protected DlBasePickerView setOutSideCancelable(boolean isCancelable) {
