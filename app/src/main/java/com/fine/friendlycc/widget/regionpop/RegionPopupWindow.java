package com.fine.friendlycc.widget.regionpop;
...
public class RegionPopupWindow extends PopupWindow {
    ...
    public RegionPopupWindow(Activity activity, List<String> datas) {
        super(activity);
...
//    }
    ...
    public interface OnItemClickListener {
        void onItemClick(RegionPopupWindow popupWindow, int position);
    }
    ...
    public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.RecyclerHolder> {
        ...
        public void onBindViewHolder(@NonNull RecyclerHolder holder, int position) {
            ...
            holder.itemView.setOnClickListener(v -> {
                ...
                selectedPosition = p;
                if (mListener != null) {
                    mListener.onItemClick(RegionPopupWindow.this, p);
                }
            });
        }
