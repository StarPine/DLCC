...
public abstract class ImageGridViewAdapter implements Serializable {

    protected Context context;
    private List<ImageInfo> imageInfo;

    public ImageGridViewAdapter(Context context, List<ImageInfo> imageInfo) {
    ...
    protected ImageView generateImageView(Context context) {
        ImageGridViewWrapper imageView = new ImageGridViewWrapper(context);
