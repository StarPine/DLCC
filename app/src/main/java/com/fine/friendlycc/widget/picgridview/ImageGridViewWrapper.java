package com.fine.friendlycc.widget.picgridview;
...
public class ImageGridViewWrapper extends ImageView {
    ...
    public ImageGridViewWrapper(Context context) {
        this(context, null);
    }

    public ImageGridViewWrapper(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ImageGridViewWrapper(Context context, AttributeSet attrs, int defStyleAttr) {
