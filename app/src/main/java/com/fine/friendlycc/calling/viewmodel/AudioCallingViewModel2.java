    ...
    public void startCall() {
        ...
        mTRTCCallingDelegate = new EmptyTRTCCallingDelegate() {
            ...
            public void onError(int code, String msg) {
                ...
                unListen();
                finishView();
                ToastUtils.showLong(CCApplication.instance().getString(com.tencent.liteav.trtccalling.R.string.trtccalling_toast_call_error_msg, code, msg));
            }
            ...
            public void onReject(String userId) {
                unListen();
                finishView();
                Utils.show(CCApplication.instance().getString(R.string.playcc_the_other_party_refuses_to_answer));
            ...
            public void onNoResp(String userId) {
                unListen();
                finishView();
                Utils.show(CCApplication.instance().getString(R.string.playcc_the_other_party_is_temporarily_unavailable));
            }
            ...
            public void onLineBusy(String userId) {
                unListen();
                finishView();
                Utils.show(CCApplication.instance().getString(R.string.playcc_the_other_party_is_on_a_call));
            }
    ...
    public void startCalled() {
        ...
        mTRTCCallingDelegate = new EmptyTRTCCallingDelegate() {
            ...
            public void onCallingCancel() {
                unListen();
                finishView();
                Utils.show(CCApplication.instance().getString(R.string.playcc_the_other_party_cancels_the_call));
            }
