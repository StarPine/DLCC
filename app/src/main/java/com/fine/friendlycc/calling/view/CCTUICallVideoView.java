...
public class CCTUICallVideoView extends BaseTUICallView {
    ...
    public CCTUICallVideoView(Context context, TUICalling.Role role, String[] userIDs, String sponsorID, String groupID, boolean isFromGroup, VideoLayoutFactory videoLayoutFactory) {
    ...
    public CCTUICallVideoView(Context context, TUICalling.Role role, String[] userIDs, String sponsorID, String groupID, boolean isFromGroup, int roomId, VideoLayoutFactory videoLayoutFactory) {
