 ...
 * 修改备注：
 */
public class CallingStatusBean {
    /**
     * roomId : 1901314475
     * roomStatus : 101
     * totalMinutes : 246
    ...
    public CallingStatusBean(Integer roomId, Integer roomStatus, Integer totalMinutes, Integer elapsedMinutes, Integer remainingMinutes, Integer frozenCoins, Integer payerCoinBalance, BigDecimal payeeProfits) {
        this.roomId = roomId;
