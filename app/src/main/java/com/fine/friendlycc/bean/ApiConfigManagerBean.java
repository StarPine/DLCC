 ...
 * Description: API配置类
 */
public class ApiConfigManagerBean implements Parcelable {
    //playchat web网址
    ...
    protected ApiConfigManagerBean(Parcel in) {
    ...
    public static final Creator<ApiConfigManagerBean> CREATOR = new Creator<ApiConfigManagerBean>() {
        @Override
        public ApiConfigManagerBean createFromParcel(Parcel in) {
            return new ApiConfigManagerBean(in);
        }

        @Override
        public ApiConfigManagerBean[] newArray(int size) {
            return new ApiConfigManagerBean[size];
        }
    };
