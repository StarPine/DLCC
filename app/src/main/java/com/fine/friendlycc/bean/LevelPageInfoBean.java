 ...
 */
public class LevelPageInfoBean {
    //等级权益列表
    private LevelSelectInfoBean levelSelectInfo;
    //提示文案如：每天只能修改1次
    ...
    public LevelSelectInfoBean getLevelSelectInfo() {
        return levelSelectInfo;
    }

    public void setLevelSelectInfo(LevelSelectInfoBean levelSelectInfo) {
