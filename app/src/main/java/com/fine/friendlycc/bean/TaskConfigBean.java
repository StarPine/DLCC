...
//    public EjectConfigBean getConfig() {
//        return config;
//    }
//
//    public void setConfig(EjectConfigBean config) {
//        this.config = config;
//    }
    ...
    public List<TaskConfigItemBean> getTask() {
        return task;
    }

    public void setTask(List<TaskConfigItemBean> task) {
        this.task = task;
    }
