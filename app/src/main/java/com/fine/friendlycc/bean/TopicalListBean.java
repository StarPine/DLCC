...
public class TopicalListBean extends BaseObservable {
    ...
    private int userId;
    private BaseUserBeanBean user;
    private BroadcastBeanBean broadcast;
    @SerializedName("is_give")
    private int isGive;
    @SerializedName("give_count")
    private int giveCount;
    private List<GiveUserBeanBean> give_user;
    ...
    public BaseUserBeanBean getUser() {
        return user;
    }

    public void setUser(BaseUserBeanBean user) {
        this.user = user;
    }

    public BroadcastBeanBean getBroadcast() {
        return broadcast;
    }

    public void setBroadcast(BroadcastBeanBean broadcast) {
    ...
    @Bindable
    public List<GiveUserBeanBean> getGive_user() {
        return give_user;
    }

    public void setGive_user(List<GiveUserBeanBean> give_user) {
