 ...
 * Description: This is LevelSelectInfoEntity
 */
public class LevelSelectInfoEntity {
    ...
    public class LevelInfo {
         ...
         * 讯息钻石范围
         */
        private LevelPageInfoEntity.CoinsRangeInfo chatCoinsRange;

        /**
         * 语音钻石范围
         */
        private LevelPageInfoEntity.CoinsRangeInfo voiceCoinsRange;

        /**
         * 视讯钻石范围
         */
        private LevelPageInfoEntity.CoinsRangeInfo videoCoinsRange;
        ...
        public LevelPageInfoEntity.CoinsRangeInfo getChatCoinsRange() {
            return chatCoinsRange;
        }

        public void setChatCoinsRange(LevelPageInfoEntity.CoinsRangeInfo chatCoinsRange) {
            this.chatCoinsRange = chatCoinsRange;
        }

        public LevelPageInfoEntity.CoinsRangeInfo getVoiceCoinsRange() {
            return voiceCoinsRange;
        }

        public void setVoiceCoinsRange(LevelPageInfoEntity.CoinsRangeInfo voiceCoinsRange) {
            this.voiceCoinsRange = voiceCoinsRange;
        }

        public LevelPageInfoEntity.CoinsRangeInfo getVideoCoinsRange() {
            return videoCoinsRange;
        }

        public void setVideoCoinsRange(LevelPageInfoEntity.CoinsRangeInfo videoCoinsRange) {
