 ...
 */
public class DlOptionsPickerView<T> extends DlBasePickerView implements View.OnClickListener {

    private DlWheelOptions<T> wheelOptions;

    private static final String TAG_SUBMIT = "submit";
    private static final String TAG_CANCEL = "cancel";


    public DlOptionsPickerView(DlPickerOptions pickerOptions) {
    ...
    private void initView(Context context) {
        ...
        if (mPickerOptions.customListener == null) {
            ...
            TextView tvBottomTip = (TextView) findViewById(R.id.tv_bottom_tip);
            ...
            tvBottomTip.setText(TextUtils.isEmpty(mPickerOptions.textContentBottomTip) ? "" : mPickerOptions.textContentBottomTip);//默认为空
        ...
        wheelOptions = new DlWheelOptions<>(optionsPicker, mPickerOptions.isRestoreItem);
