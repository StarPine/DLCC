 ...
 * 3d滚轮控件
 */
public class DlWheelView extends View {
    ...
    public DlWheelView(Context context) {
        this(context, null);
    }

    public DlWheelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.dlpickerview, 0, 0);
            mGravity = a.getInt(R.styleable.dlpickerview_dlwheelview_gravity, Gravity.CENTER);
            textColorOut = a.getColor(R.styleable.dlpickerview_dlwheelview_textColorOut, 0xFFa8a8a8);
            textColorCenter = a.getColor(R.styleable.dlpickerview_dlwheelview_textColorCenter, 0xFF2a2a2a);
            dividerColor = a.getColor(R.styleable.dlpickerview_dlwheelview_dividerColor, 0xFFd5d5d5);
            dividerWidth = a.getDimensionPixelSize(R.styleable.dlpickerview_dlwheelview_dividerWidth, 2);
            textSize = a.getDimensionPixelOffset(R.styleable.dlpickerview_dlwheelview_textSize, textSize);
            lineSpacingMultiplier = a.getFloat(R.styleable.dlpickerview_dlwheelview_lineSpacingMultiplier, lineSpacingMultiplier);
            a.recycle();//回收内存
        }
    ...
    private void initLoopView(Context context) {
        ...
        handler = new DlMessageHandler(this);
        gestureDetector = new GestureDetector(context, new DlLoopViewGestureListener(this));
    ...
    public void smoothScroll(ACTION action) {//平滑滚动的实现
        ...
        mFuture = mExecutor.scheduleWithFixedDelay(new DlSmoothScrollTimerTask(this, mOffset), 0, 10, TimeUnit.MILLISECONDS);
    }

    public final void scrollBy(float velocityY) {//滚动惯性的实现
        cancelFuture();
        mFuture = mExecutor.scheduleWithFixedDelay(new DlInertiaTimerTask(this, velocityY), 0, VELOCITY_FLING, TimeUnit.MILLISECONDS);
    }
