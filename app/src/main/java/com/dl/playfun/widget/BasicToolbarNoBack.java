 ...
 * @Version 1.0
 **/
public class BasicToolbarNoBack extends Toolbar implements View.OnClickListener {
    ...
    public BasicToolbarNoBack(Context context) {
        this(context, null);
    }

    public BasicToolbarNoBack(Context context, AttributeSet attrs) {
     ...
     * @param defStyleAttr
     */
    public BasicToolbarNoBack(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public interface ToolbarListener {
         ...
         * @param toolbar
         */
        void onBackClick(BasicToolbarNoBack toolbar);
    }
}