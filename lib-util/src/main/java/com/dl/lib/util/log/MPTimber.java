...
/**
 * Author: 彭石林
 * Time: 2022/7/16 15:28
 * Description: This is Timber
 */
public final class MPTimber {
    ...
    /** A facade for handling logging calls. Install instances via . */
    ...
    public static class DebugTree extends Tree {
         ...
         * becomes {@code Foo}).
         * <p>
         * Note: This will not be called if a  was specified.
         */
        @Nullable
