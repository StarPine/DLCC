...
package com.aliyun.svideo.beauty.queen.adapter;
...
import com.aliyun.svideo.beauty.queen.adapter.holder.BaseCaptionViewHolder;

import java.util.ArrayList;
import java.util.List;

public class RaceViewPagerAdapter extends PagerAdapter implements PagerSlidingTabStrip.IconTabProvider{
    private final List<BaseCaptionViewHolder> mTabHolder = new ArrayList<>();
