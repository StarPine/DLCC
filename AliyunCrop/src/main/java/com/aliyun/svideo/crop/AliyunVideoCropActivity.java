...
public class AliyunVideoCropActivity extends Activity implements TextureView.SurfaceTextureListener, HorizontalListView.OnScrollCallBack, SizeChangedNotifier.Listener,
    ...
    private void initView() {
        ...
        dirationTxt.setText(Math.round((float) duration / 1000) + "s");
    ...
    private final VideoSliceSeekBar.SeekBarChangeListener mSeekBarListener = new VideoSliceSeekBar.SeekBarChangeListener() {
        ...
        public void seekBarValueChanged(float leftThumb, float rightThumb, int whitchSide) {
            ...
            dirationTxt.setText(Math.round((float) (mEndTime - mStartTime) / 1000) + "s");
            if (mPlayer != null) {
    ...
    public void onClick(View v) {
        if (v == transFormBtn) {
            ...
            if( mEndTime > 20500){
                ToastUtil.showToast(this, R.string.alivc_crop_video_tip_error2);
                return;
            }
            switch (mAction) {
